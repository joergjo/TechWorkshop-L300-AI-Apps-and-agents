...
class AgentProcessor:
    ...
    def run_conversation_with_image(
        self, input_message: str = "", image_path: str = ""
    ):
        ...
        message = self.project_client.agents.messages.create(
            thread_id=thread_id, role="user", content=content_blocks
        )
    ...
    def _run_conversation_sync(self, input_message: str = ""):
        ...
        try:
            ...
            messages = list(
                self.project_client.agents.messages.list(thread_id=thread_id, limit=1)
            )
            print(
